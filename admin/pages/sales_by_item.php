<?php
	...
	$reports = $reportsDAO->getSalesByItem()->fetchAll();
	$start_date = "";
	$end_date = "";
	if(isset($_POST['search'])){
		...
		if(!empty($start_date) && !empty($end_date)){
			$reports = $reportsDAO->getSalesByItemByDate($start_date, $end_date)->fetchAll();
		}
	}
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sales By Artifact</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->

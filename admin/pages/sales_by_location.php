<?php
	...
	$reports = $reportsDAO->getSalesByLocation()->fetchAll();
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sales By Location</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row 
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($reports as $report) {
                                                echo "<tr>";
                                                    echo "<td>";
                                                        echo $report["addr_country"];
                                                    echo "</td>";
                                                    echo "<td>";
														$total_customer = $report["total_customer"];
														if (strcasecmp($total_customer,"")==0){
															$total_customer = 0;
														}
                                                        echo $total_customer;
                                                    echo "</td>";

<?php
	...
	$reports = $reportsDAO->getSalesByDay()->fetchAll();
	...
	if(isset($_POST['search'])){
		...
		if(!empty($start_date) && !empty($end_date)){
			$reports = $reportsDAO->filterSalesByDayByDate($start_date, $end_date)->fetchAll();
		}
	}
 ?>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sales Per Day</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
